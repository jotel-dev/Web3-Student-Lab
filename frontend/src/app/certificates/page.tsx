    ...
    return (
      <div className="min-h-[calc(100vh-80px)] flex items-center justify-center bg-black">
        <div className="text-center">
          ...
          <p className="text-red-500 font-mono uppercase tracking-widest text-sm">Decrypting Vault...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        {certificates.length === 0 ? (
          <div className="bg-zinc-950 border border-white/10 p-12 text-center rounded-2xl shadow-[0_0_30px_rgba(220,38,38,0.05)]">
            ...
            <h2 className="text-2xl font-black text-white uppercase tracking-widest mb-4">Vault Empty</h2>
            <p className="text-gray-500 mb-8 max-w-md mx-auto">No cryptographic tokens found on-chain for this operator. Connect to a learning node to begin extracting credentials.</p>
            <Link href="/courses" className="inline-block px-8 py-4 bg-white text-black font-black uppercase tracking-widest rounded-xl hover:bg-gray-200 transition-colors shadow-[0_0_20px_rgba(255,255,255,0.2)]">
              Scan Nodes
            </Link>
          </div>
        ) : (
              ...
              >
                ...
                <div className="flex items-start justify-between mb-8 relative z-10">
                  <div className="w-16 h-16 bg-black border border-red-500/30 rounded-2xl flex items-center justify-center shadow-inner">
                    <svg className="w-8 h-8 text-red-500 drop-shadow-[0_0_8px_rgba(220,38,38,0.8)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z" />
                    </svg>
                  </div>
                  <div className="text-right">
                    <span className="block text-[10px] text-gray-500 uppercase tracking-widest mb-1">Mint Date</span>
                ...
                <div className="text-sm font-mono text-red-500/80 mb-6 truncate">
                  TX: {cert.certificateHash ? `${cert.certificateHash.substring(0, 16)}...` : 'PENDING'}
                </div>
                
                <div className="pt-6 border-t border-white/10 flex justify-between items-center">
                  <span className="text-xs font-bold text-gray-500 uppercase tracking-widest group-hover:text-gray-300 transition-colors">Web3 Lab Identity</span>
                  <span className="text-xs font-bold text-red-500 uppercase tracking-widest group-hover:text-red-400 flex items-center gap-1">
                    Inspect Asset <span className="transform group-hover:translate-x-1 transition-transform">→</span>
                  </span>
                </div>
              </Link>
            ))}
