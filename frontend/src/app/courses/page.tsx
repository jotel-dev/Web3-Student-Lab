        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 relative z-10">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-black text-white tracking-tighter uppercase mb-2">Modules</h1>
              <p className="text-gray-400 font-light text-lg">Master Soroban and Stellar via hands-on progression</p>
            </div>
            <Link
              href="/dashboard"
            ...
            >
              <span className="transform group-hover:-translate-x-1 transition-transform">←</span> Access Control
            </Link>
          </div>
        </div>
      </div>
        ...
        <div className="relative z-10">
          {filteredCourses.length === 0 ? (
            <div className="text-center py-20 border border-white/10 rounded-2xl bg-zinc-950/50 backdrop-blur-sm">
              ...
              <h3 className="mt-2 text-xl font-black text-white uppercase tracking-widest">No Modules Found</h3>
                ...
                >
                  ...
                  <div className="flex items-start justify-between mb-8 relative z-10">
                    <div className="w-14 h-14 bg-black border border-white/10 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:border-red-500/50 group-hover:bg-red-500/10 transition-colors">
                      <svg className="w-7 h-7 text-white group-hover:text-red-500 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                      </svg>
                    </div>
                  ...
                  <h3 className="text-2xl font-black text-white mb-3 uppercase tracking-tight group-hover:text-red-50 transition-colors">{course.title}</h3>
                  ...
                  <div className="flex items-center justify-between pt-6 border-t border-white/10 mt-auto">
                    <span className="text-xs font-bold text-gray-500 uppercase tracking-widest">{course.instructor}</span>
                    <span className="inline-flex items-center gap-2 text-red-500 font-bold uppercase text-xs tracking-widest group-hover:text-red-400 transition-colors">
                      Enter Node <span className="transform group-hover:translate-x-1 transition-transform">→</span>
                    </span>
                  </div>
                </Link>
              ))}
