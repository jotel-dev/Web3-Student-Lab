    ...
    return (
      <div className="min-h-[calc(100vh-80px)] flex items-center justify-center bg-black">
        <div className="text-center">
          ...
          <p className="text-red-500 font-mono uppercase tracking-widest text-sm">Loading Header Data...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-[calc(100vh-80px)] flex items-center justify-center bg-black">
        <div className="text-center bg-zinc-950 border border-red-500/50 p-12 rounded-2xl shadow-[0_0_30px_rgba(220,38,38,0.2)]">
          <h2 className="text-2xl font-black text-white uppercase tracking-widest mb-4">Node Not Found</h2>
          <Link href="/courses" className="text-red-500 hover:text-red-400 uppercase text-sm font-bold tracking-widest flex items-center justify-center gap-2 group">
            <span className="transform group-hover:-translate-x-1 transition-transform">←</span> Return to Directory
          </Link>
        </div>
      </div>
    );
    ...
    <div className="min-h-[calc(100vh-80px)] bg-black text-white pb-20 relative overflow-hidden">
      ...
      <div className="relative border-b border-white/10 bg-zinc-950/80 backdrop-blur-sm z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <Link href="/courses" className="text-gray-500 hover:text-red-500 uppercase text-xs font-bold tracking-widest mb-8 inline-flex items-center gap-2 group transition-colors">
            <span className="transform group-hover:-translate-x-1 transition-transform">←</span> Network Directory
          </Link>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            <div className="bg-zinc-950 border border-white/10 rounded-2xl p-8 hover:border-red-500/30 transition-colors">
              <h2 className="text-2xl font-black text-white mb-6 uppercase tracking-widest flex items-center gap-3">
                <span className="w-4 h-4 bg-red-600 rounded-sm inline-block"></span> Protocol Specifications
              </h2>
              ...
              <div className="border-t border-white/10 pt-8 mt-8">
                <h3 className="text-lg font-bold text-gray-300 mb-6 uppercase tracking-widest">Execution Objectives</h3>
            ...
            <div className="bg-black border border-white/10 rounded-2xl aspect-video flex flex-col items-center justify-center relative overflow-hidden group">
              ...
              <p className="text-gray-500 font-mono text-sm uppercase tracking-widest z-10">Stream Encrypted Feed</p>
            </div>
          </div>
          ...
          <div className="lg:col-span-1">
            <div className="bg-zinc-950 border border-white/10 rounded-2xl p-8 shadow-[0_0_30px_rgba(0,0,0,0.5)] sticky top-28">
              <h3 className="text-xl font-black text-white mb-6 uppercase tracking-widest">Connection Status</h3>
              ...
              {isEnrolled ? (
                <div className="space-y-6">
                  <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-6 text-center">
                    ...
                    <p className="text-green-500 font-bold uppercase tracking-widest text-sm mb-1">Uplink Active</p>
                    <p className="text-xs text-gray-400 font-mono">Module execution in progress...</p>
                  </div>

                  <div className="pt-6 border-t border-white/10">
                    <p className="text-gray-400 text-sm font-light mb-4">
                      Completed the curriculum? Execute the smart contract below to mint your verifiable credential on the Stellar blockchain.
                    </p>
                    
                    {mintSuccess ? (
                      <div className="bg-blue-500/10 border border-blue-500/30 rounded-xl p-4 text-center animate-pulse">
                        <p className="text-blue-500 font-bold uppercase tracking-widest text-sm">Token Minted</p>
                        <p className="text-xs text-blue-400/70 font-mono mt-1">Redirecting to Vault...</p>
                      </div>
                    ) : (
                      <button
